...
function LoginForm() {
  ...
  // Catch the "return ticket" (where to go after login)
  ...
  const handleVerify = async () => {
    ...
    // We aren't passing 'next' to email verify yet (Google is priority),
    // but this still logs them in.
      ...
      <div className={styles.loginCard}>
        ...
        <div className={styles.brandHeader}>
          ...
          <p className={styles.subtitle}>
            {step === "email" ? "Login to join community" : "Check your email"}
          </p>
        </div>
        ...
        {step === "email" ? (
          <div className={styles.contentStack}>
            {/* GOOGLE BUTTON - Passes 'next' */}
            <button
              onClick={() => signInWithSocial("google", next)}
